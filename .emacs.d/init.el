...
(custom-set-variables
 ...
 '(package-selected-packages
   '(websocket helm-ag yasnippet vterm utop tuareg swift-mode origami ocp-indent ns-auto-titlebar merlin-eldoc merlin-company merlin magit lsp-ui lsp-sourcekit lsp-pyright lsp-java lsp-haskell key-seq highlight-symbol helm-xref helm-rg helm-projectile helm-lsp flycheck exec-path-from-shell evil-vimish-fold evil-search-highlight-persist evil-leader evil-commentary esup dune doom-themes dockerfile-mode diff-hl company benchmark-init auto-dim-other-buffers apheleia aidermacs adaptive-wrap)))
