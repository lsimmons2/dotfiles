...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vterm dockerfile-mode aidermacs evil-magit magit diff-hl lsp-sourcekit swift-mode helm-xref helm-lsp lsp-pyright dap-ocaml dap-codelldb gptel yasnippet-snippets yasnippet evil-commentary tuareg helm-rg apheleia evil-leader key-chord lsp-haskell lsp-ui flycheck company ns-auto-titlebar doom-themes)))
(custom-set-faces
